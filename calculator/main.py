...
def handle_button_click(clicked_button_text):
    ...
    if clicked_button_text == "=":
        try:
            ...
            result_var.set("Error_cant_calculate")
...
# Entry widget to display thee result with larger font size
...
# Set the window size to 9:16 ratio
width = 500
height = 800
